  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      let embed = new EmbedBuilder()
        ...
        .setTimestamp()
        .setFooter({ text: `EstrellaStudios`, iconURL: `https://images-ext-1.discordapp.net/external/cOiQ-fzDFMF8NepwhjH1-DeUclVbVy6p1K56JJKY4EE/https/cdn.discordapp.com/icons/888896257454653482/789fcb9cb921f56724b33d6879f12c01.webp` })
        ...
        col.on('collect', async (button) => {
          ...
          switch (button.customId) {
            ...
            case 'es':
              ...
              await interaction.editReply({ content: `Idioma del bot cambiado a español con exito. :flag_es:`, embeds: [], components: [], ephemeral: true }).catch(e => { })
              await button.deferUpdate().catch(e => { })
              await col.stop()
              break
            case 'pt':
